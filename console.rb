...
customer2.save()
customer3 = Customer.new('name' => 'Chesser', 'funds' => '100')
customer3.save()
...
screening2.save()
screening3 = Screening.new('showtime' => '16:00', 'capacity' => '25', 'film_id' => film1.id)
screening3.save()
screening4 = Screening.new('showtime' => '15:00', 'capacity' => '75', 'film_id' => film2.id)
screening4.save()
screening5 = Screening.new('showtime' => '17:00', 'capacity' => '45', 'film_id' => film2.id)
screening5.save()
screening6 = Screening.new('showtime' => '19:00', 'capacity' => '15', 'film_id' => film2.id)
screening6.save()
