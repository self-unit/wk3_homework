...
screening1 = Screening.new('time' => '10:00', 'film_id' => film1.id)
screening1.save()
screening2 = Screening.new('time' => '14:00', 'film_id' => film1.id)
screening2.save()
screening3 = Screening.new('time' => '16:00', 'film_id' => film1.id)
screening3.save()
screening4 = Screening.new('time' => '15:00', 'film_id' => film2.id)
screening4.save()
screening5 = Screening.new('time' => '17:00', 'film_id' => film2.id)
screening5.save()
screening6 = Screening.new('time' => '19:00', 'film_id' => film2.id)
screening6.save()
